...
metadata:
  hermes:
    ...
    related_skills: [claude-code, code-agents, kanban]
---
...
For specialized Hermes topics not covered in the main sections above:

| Topic | Reference |
|-------|-----------|
| **Authoring in-repo (bundled) skills** | `references/in-repo-skill-authoring.md` — conventions, frontmatter, directory placement, validation |
| **s6-overlay container supervision** | `references/s6-container-supervision.md` — Docker image architecture, profile gateway management, troubleshooting |
