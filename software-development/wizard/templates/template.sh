...
banner() {
  ...
  printf '  and captures the values you copy back. Stop any time with Ctrl-C.%s\n' "$RESET"
...
# Set TOTAL_STAGES below. Replace the example Stripe stage.
# ══════════════════════════════════════════════════════════════════════════

TOTAL_STAGES=1

banner "Example: Stripe setup"

# ── Example stage: replace with your real steps ───────────────────────────
stage "Stripe — API keys"
say "Grab your Stripe test keys and store them for local dev + CI."
